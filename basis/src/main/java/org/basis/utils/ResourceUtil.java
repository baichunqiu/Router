...
public class ResourceUtil {
    ...
    public static byte[] readBytesFromAssets(String fileName) {
        ...
        byte[] buffer = null;
        try {
            is = UIUtil.getAssets().open(fileName);
    ...
    public static byte[] readBytesFromRaw(int rawId) {
        ...
        byte[] buffer = null;
        try {
            is = UIUtil.getResources().openRawResource(rawId);
            int size = is.available();
            buffer = new byte[size];
            is.read(buffer);
        } catch (IOException e) {
    ...
    public static String getString(int strId) {
        return UIUtil.getResources().getString(strId);
    }
    ...
    public static int getColor(int colorId) {
        return UIUtil.getResources().getColor(colorId);
    }
    ...
    public static Drawable getDrawable(int drawableId) {
        return UIUtil.getResources().getDrawable(drawableId);
    }
    ...
    public static String[] getStringArray(int resID) {
        return UIUtil.getResources().getStringArray(resID);
    }
    ...
    public static int[] getIntArray(int resID) {
        return UIUtil.getResources().getIntArray(resID);
    }
    ...
    public static float getDimension(Context ctx, int resID) {
        return UIUtil.getResources().getDimension(resID);
    }
