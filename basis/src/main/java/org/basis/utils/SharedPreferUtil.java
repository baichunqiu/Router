...
public class SharedPreferUtil {
    ...
    public static void set(String key, String value) {
        set(Constant.SP_DEFAULT, key, value);
    }
    ...
    public static void set(String fileName, String key, String value) {
        SharedPreferences sharedPreferences = UIUtil.getContext().getSharedPreferences(fileName, Context.MODE_MULTI_PROCESS);
    ...
    public static String get(String fileName, String key, String defaultValue) {
        ...
        return UIUtil.getContext().getSharedPreferences(fileName, Context.MODE_MULTI_PROCESS).getString(key, defaultValue);
    }
    ...
    public static String get(String key) {
        return get(Constant.SP_DEFAULT, key, "");
    }
    ...
    public static boolean getBoolean(String key) {
        return get(Constant.SP_DEFAULT, key, false);
    }
    /**
     * 移除key对应的项
     *
    ...
    public static boolean contatins(String fileName, String key) {
        return UIUtil.getContext().getSharedPreferences(fileName, Context.MODE_MULTI_PROCESS).contains(key);
    }
    ...
    public static Map<String, ?> getAll(String fileName) {
        return UIUtil.getContext().getSharedPreferences(fileName, Context.MODE_MULTI_PROCESS).getAll();
    }
