...
import org.router.annoation.StaticRouter;
...
public class RouterProcessor extends AbstractProcessor {
    //roouter库下Router文件的根目录保持一致
    private final static String ROUTER_PATH = "org.router";
    private final static String RULE_PATH = "org.router.rule";
